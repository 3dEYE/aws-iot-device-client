...
[![Build and test](https://github.com/3dEYE/aws-iot-device-client/actions/workflows/pull-request.yml/badge.svg?branch=dev&event=push)](https://github.com/3dEYE/aws-iot-device-client/actions/workflows/pull-request.yml)
